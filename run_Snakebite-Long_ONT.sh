...
projectFolder="/scratch/project_2010176/metaG-ONT"
...
################################################################################
export APPTAINER_TMPDIR="/scratch/project_2010176/tmp"
export APPTAINER_CACHEDIR="/scratch/project_2010176/tmp"
mkdir -p $APPTAINER_TMPDIR
mkdir -p $APPTAINER_CACHEDIR

# For use with Singularity, set these variables
################################################################################
# export SINGULARITY_TMPDIR="/scratch/project_2010176/tmp"
# export SINGULARITY_CACHEDIR="/scratch/project_2010176/tmp"
